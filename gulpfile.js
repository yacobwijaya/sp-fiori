...
gulp.task('copy-asset-files', function() {
    ...
    gulp.src(['./src/assets/css/*']).pipe(gulp.dest('build/assets/css/'));
    gulp.src(['./node_modules/bootstrap/dist/js/*']).pipe(gulp.dest('build/node_modules/bootstrap/dist/js'));
    gulp.src(['./node_modules/bootstrap/dist/css/*']).pipe(gulp.dest('build/node_modules/bootstrap/dist/css'));
    gulp.src(['./node_modules/bootstrap/dist/fonts/*']).pipe(gulp.dest('build/node_modules/bootstrap/dist/fonts'));
    gulp.src(['./node_modules/startbootstrap-simple-sidebar/css/*']).pipe(gulp.dest('build/node_modules/startbootstrap-simple-sidebar/css/'));
    gulp.src(['./node_modules/startbootstrap-simple-sidebar/js/*']).pipe(gulp.dest('build/node_modules/startbootstrap-simple-sidebar/js/'));
    gulp.src(['./src/example/*']).pipe(gulp.dest('build/example/'));
});
